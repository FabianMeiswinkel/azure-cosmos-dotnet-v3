...
namespace HdrHistogram
{
    ...
    /// </para>
    /// </remarks>
    internal abstract class HistogramBase : IRecorder, IDisposable
    {
        ...
        public virtual IEnumerable<HistogramIterationValue> RecordedValues()
        {
        ...
        /// </summary>
        /// <returns>An enumerator of <see cref="HistogramIterationValue"/> through the histogram using a <see cref="RecordedValuesEnumerator"/></returns>
        public virtual IEnumerable<HistogramIterationValue> AllValues()
        {
